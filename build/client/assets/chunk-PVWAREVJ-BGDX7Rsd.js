...
var jr;
function va() {
  return (jr || ((jr = 1), (zt.exports = ya())), zt.exports);
}
var Rl = va(),
  Bt = { exports: {} },
  Y = {};
  ...
  return (
    ...
    (Y.cloneElement = function (m, x, $) {
      ...
      if (B === 1) _.children = $;
        ...
        for (var Se = Array(B), ie = 0; ie < B; ie++)
    ...
    (Y.isValidElement = j),
    (Y.lazy = function (m) {
      return { $$typeof: c, _payload: { _status: -1, _result: m }, _init: ae };
    }),
    (Y.memo = function (m, x) {
...
var Ur;
function wa() {
  return (Ur || ((Ur = 1), (Bt.exports = ga())), Bt.exports);
}
var h = wa();
const bl = pa(h);
/**
 ...
 */ var hn = e => {
  ...
  Ea = (e, t, r) => t.has(e) || hn('Cannot ' + r),
  Wt = (e, t, r) => (
    Ea(e, t, 'read from private field'),
    r ? r.call(e) : t.get(e)
  ),
  Ra = (e, t, r) =>
    t.has(e)
...
function Sa(e, t, r, n = {}) {
  ...
  function f() {
    ...
    let w = c(),
      S = w == null ? null : w - u;
    ((u = w), l && l({ action: s, location: M.location, delta: S }));
  }
  function p(w, S) {
    s = 'PUSH';
    let P = ot(M.location, w, S);
    u = c() + 1;
    let O = Br(P, u),
      k = M.createHref(P);
    try {
...
var at,
  Wr = class {
    constructor(e) {
      if ((Ra(this, at, new Map()), e)) for (let [t, r] of e) this.set(t, r);
    }
    get(e) {
...
function yn(e, t = [], r = [], n = '', a = !1) {
  let o = (i, s, l = a, u) => {
    ...
    (i.children &&
      ...
      !(i.path == null && !i.index) &&
        t.push({ path: f, score: $a(f, i.index), routesMeta: p }));
  };
  return (
    e.forEach((i, s) => {
      var l;
...
function $a(e, t) {
  ...
  return (
    ...
    r
      .filter(a => !Yr(a))
      .reduce((a, o) => a + (_a.test(o) ? Da : o === '' ? Aa : ka), n)
  );
}
function Ia(e, t) {
  ...
  for (let s = 0; s < n.length; ++s) {
    ...
    (Object.assign(a, f.params),
      i.push({
        ...
        pathnameBase: Ba(Ce([o, f.pathnameBase])),
        route: p,
      }),
...
function Ha({ basename: e, pathname: t }) {
  return t === '/' ? e : Ce([e, t]);
}
function Ua(e, t = '/') {
  let {
...
function Ja(e, t) {
  return new Va(e, typeof t == 'number' ? { status: t } : t);
}
var Ga = (e, t = 302) => {
    let r = t;
    typeof r == 'number'
...
var En = ['POST', 'PUT', 'PATCH', 'DELETE'],
  ...
  Ka = ['GET', ...En],
  qa = new Set(Ka),
  Qa = new Set([301, 302, 303, 307, 308]),
  Za = new Set([307, 308]),
  Vt = {
    state: 'idle',
    location: void 0,
...
function xl(e) {
  ...
  let n = e.hydrationRouteProperties || [],
    a = e.mapRouteProperties || ro,
    o = {},
    i = it(e.routes, a, void 0, o),
    s,
    l = e.basename || '/';
  l.startsWith('/') || (l = `/${l}`);
  let u = e.dataStrategy || lo,
    c = { ...e.future },
    f = null,
    p = new Set(),
    g = null,
    ...
    S = Me(i, e.history.location, l),
    P = !1,
    O = null,
    k;
  if (S == null && !e.patchRoutesOnNavigation) {
    let d = Ee(404, { pathname: e.history.location.pathname }),
    ...
    if (S.some(d => d.route.lazy)) k = !1;
    else if (!S.some(d => d.route.loader)) k = !0;
    else {
      ...
      if (y) {
        ...
        k = S.slice(0, E + 1).every(C => !Zt(C.route, d, y));
      } else k = S.every(E => !Zt(E.route, d, y));
    }
  else {
    ((k = !1), (S = []));
  ...
  function ie() {
    (f && f(),
      ...
      p.clear(),
      j && j.abort(),
      v.fetchers.forEach((d, y) => jt(y)),
      v.blockers.forEach((d, y) => Ar(y)));
  }
  function It(d) {
  ...
  function he(d, y = {}) {
    (d.matches &&
      (d.matches = d.matches.map(T => {
        let N = o[T.route.id],
          I = T.route;
        return I.element !== N.element ||
          I.errorElement !== N.errorElement ||
          I.hydrateFallbackElement !== N.hydrateFallbackElement
          ? { ...T, route: N }
          : T;
      })),
      (v = { ...v, ...d }));
    let E = [],
      C = [];
    (v.fetchers.forEach((T, N) => {
      T.state === 'idle' && (_.has(N) ? E.push(N) : C.push(N));
    }),
      _.forEach(T => {
        !v.fetchers.has(T) && !K.has(T) && E.push(T);
      }),
      [...p].forEach(T =>
        T(v, {
          deletedFetchers: E,
      ...
      E.forEach(T => jt(T)),
      C.forEach(T => v.fetchers.delete(T)));
  }
  function Ye(d, y, { flushSync: E } = {}) {
    ...
    let N = y.loaderData
        ...
        : v.loaderData,
      I = v.blockers;
    I.size > 0 && ((I = new Map(I)), I.forEach((W, ee) => I.set(ee, tt)));
    let D = le ? !1 : $r(d, y.matches || v.matches),
      F =
        H === !0 ||
        (v.navigation.formMethod != null &&
          ve(v.navigation.formMethod) &&
          ((A = d.state) == null ? void 0 : A._isRedirect) !== !0);
    (s && ((i = s), (s = void 0)),
      le ||
        L === 'POP' ||
        (L === 'PUSH'
  ...
  async function Lr(d, y) {
    ...
    let E = Qt(
      ...
      { path: C, submission: T, error: N } = Vr(!1, E, y),
      I = v.location,
      D = ot(v.location, C, y && y.state);
    ...
    let U =
      ...
      A = (y && y.flushSync) === !0,
      W = kr({ currentLocation: I, nextLocation: D, historyAction: z });
    if (W) {
      ft(W, {
        state: 'blocked',
        location: D,
  ...
  function ta() {
    (B || (B = Co()), Ft(), he({ revalidation: 'loading' }));
    let d = B.promise;
  ...
  async function $e(d, y, E) {
    ...
    if (
      ...
      Ye(y, { matches: N }, { flushSync: I });
      return;
    }
    let D = ht(N, C, y.pathname);
    if ((D.active && D.matches && (N = D.matches), !N)) {
      let { error: pe, notFoundMatches: ne, route: te } = Ht(y.pathname);
      Ye(
        y,
    ...
    let F = Je(e.history, y, j.signal, E && E.submission),
      ...
      U;
    if (E && E.pendingError)
      U = [Ae(N).route.id, { type: 'error', error: E.pendingError }];
    ...
    A ||
      ((j = null),
      Ye(y, { matches: W || N, ...rn(U), loaderData: ee, errors: ce }));
  }
  async function ra(d, y, E, C, T, N, I, D = {}) {
    Ft();
    let F = Ro(y, E);
    if ((he({ navigation: F }, { flushSync: D.flushSync === !0 }), N)) {
      let A = await mt(C, y.pathname, d.signal);
      ...
      if (A.type === 'error') {
        if (A.partialMatches.length === 0) {
          ...
          return {
            matches: ee,
            pendingActionResult: [ce.id, { type: 'error', error: A.error }],
          };
        }
        let W = Ae(A.partialMatches).route.id;
        return {
          matches: A.partialMatches,
          pendingActionResult: [W, { type: 'error', error: A.error }],
        };
      } else if (A.matches) C = A.matches;
      else {
        let { notFoundMatches: W, error: ee, route: ce } = Ht(y.pathname);
        return {
          matches: W,
    ...
    if (!U.route.action && !U.route.lazy)
      ...
      let A = Ge(a, o, d, C, U, I ? [] : n, T),
        W = await qe(d, A, T, null);
      if (((z = W[U.route.id]), !z)) {
        for (let ee of C)
          if (W[ee.route.id]) {
            z = W[ee.route.id];
    ...
    if (Ue(z)) {
      ...
      return (
        ...
        await Ie(d, z, !0, { submission: E, replace: A }),
        { shortCircuited: !0 }
      );
    }
    if (ge(z)) {
      let A = Ae(C, U.route.id);
      return (
        (D && D.replace) !== !0 && (L = 'PUSH'),
        { matches: C, pendingActionResult: [A.route.id, z, U.route.id] }
      );
    }
    return { matches: C, pendingActionResult: [U.route.id, z] };
  }
  async function na(d, y, E, C, T, N, I, D, F, z, U, A) {
    let W = N || Jt(y, I),
      ee = I || D || nn(W),
      ce = !le && !z;
    if (T) {
      ...
      if (q.type === 'error') {
        ...
        let me = Ae(q.partialMatches).route.id;
        return {
        ...
        let { error: me, notFoundMatches: Ve, route: He } = Ht(y.pathname);
    ...
    if (ce) {
      ...
      (te.length > 0 && (q.fetchers = aa(te)), he(q, { flushSync: U }));
    }
    te.forEach(q => {
    ...
    let { loaderResults: Qe, fetcherResults: De } = await Mr(ne, te, d, C);
    if (d.signal.aborted) return { shortCircuited: !0 };
    ...
    if (xe)
      return (
        await Ie(d, xe.result, !0, { replace: F }),
        { shortCircuited: !0 }
      );
    if (((xe = wt(De)), xe))
      return (
    ...
    let { loaderData: Ut, errors: Ze } = en(v, E, Qe, A, te, De);
    z && v.errors && (Ze = { ...v.errors, ...Ze });
    let je = Dr(),
      pt = Or(fe),
    ...
    return (
      d.forEach(y => {
        let E = v.fetchers.get(y.key),
          C = rt(void 0, E ? E.data : void 0);
        v.fetchers.set(y.key, C);
      }),
      new Map(v.fetchers)
    );
  }
  async function oa(d, y, E, C) {
    _e(d);
    let T = (C && C.flushSync) === !0,
      N = s || i,
      I = Qt(v.location, v.matches, l, E, y, C == null ? void 0 : C.relative),
      D = Me(N, I, l),
      F = ht(D, N, I);
    if ((F.active && F.matches && (D = F.matches), !D)) {
      Pe(d, y, Ee(404, { pathname: I }), { flushSync: T });
      return;
    }
    let { path: z, submission: U, error: A } = Vr(!0, I, C);
    if (A) {
      Pe(d, y, A, { flushSync: T });
      return;
    }
    let W = e.unstable_getContext ? await e.unstable_getContext() : new Wr(),
      ee = (C && C.preventScrollReset) === !0;
    if (U && ve(U.formMethod)) {
      await ia(d, y, z, D, W, F.active, T, ee, U);
      return;
    }
    (x.set(d, { routeId: y, path: z }),
      await la(d, y, z, D, W, F.active, T, ee, U));
  }
  async function ia(d, y, E, C, T, N, I, D, F) {
    (Ft(), x.delete(d));
    let z = v.fetchers.get(d);
    Te(d, bo(F, z), { flushSync: I });
    let U = new AbortController(),
      A = Je(e.history, E, U.signal, F);
    if (N) {
      let se = await mt(C, new URL(A.url).pathname, A.signal, d);
      ...
      if (se.type === 'error') {
        ...
        Pe(d, y, Ee(404, { pathname: E }), { flushSync: I });
        return;
      }
    }
    let W = Ct(C, E);
    if (!W.route.action && !W.route.lazy) {
      let se = Ee(405, { method: F.formMethod, pathname: E, routeId: y });
    ...
    let ee = ae,
      ce = Ge(a, o, A, C, W, n, T),
      ne = (await qe(A, ce, T, d))[W.route.id];
    if (A.signal.aborted) {
      ...
      if (Ue(ne))
        if ((K.delete(d), fe > ee)) {
          ...
          return (
            m.add(d),
            Te(d, rt(F)),
            Ie(A, ne, !1, { fetcherSubmission: F, preventScrollReset: D })
          );
      if (ge(ne)) {
        Pe(d, y, ne.error);
        return;
    ...
    let Ut = rt(F, ne.data);
    v.fetchers.set(d, Ut);
    let { dsMatches: Ze, revalidatingFetchers: je } = Jr(
      Fe,
      T,
      a,
      o,
    ...
    (je
      ...
      .forEach(se => {
        let vt = se.key,
          ...
          ma = rt(void 0, Ir ? Ir.data : void 0);
        (v.fetchers.set(vt, ma),
          _e(vt),
    ...
    let { loaderResults: yt, fetcherResults: q } = await Mr(Ze, je, Fe, T);
    ...
    (Or(xe),
      v.navigation.state === 'loading' && xe > fe
  ...
  async function la(d, y, E, C, T, N, I, D, F) {
    let z = v.fetchers.get(d);
    Te(d, rt(F, z ? z.data : void 0), { flushSync: I });
    let U = new AbortController(),
      A = Je(e.history, E, U.signal);
    if (N) {
      let te = await mt(C, new URL(A.url).pathname, A.signal, d);
    ...
    let ee = ae,
      ce = Ge(a, o, A, C, W, n, T),
      ne = (await qe(A, ce, T, d))[W.route.id];
    if ((K.get(d) === U && K.delete(d), !A.signal.aborted)) {
      if (_.has(d)) {
        Te(d, Oe(void 0));
        return;
      }
      if (Ue(ne))
        if (fe > ee) {
          ...
          (m.add(d), await Ie(A, ne, !1, { preventScrollReset: D }));
          return;
        }
      if (ge(ne)) {
        Pe(d, y, ne.error);
  ...
  async function Ie(
    ...
    let F = ot(v.location, D, { _isRedirect: !0 });
    if (r) {
      let ce = !1;
    ...
    let z =
        I === !0 || y.response.headers.has('X-Remix-Replace')
          ? 'REPLACE'
          : 'PUSH',
      { formMethod: U, formAction: A, formEncType: W } = v.navigation;
    !C && !T && U && A && W && (C = nn(v.navigation));
    let ee = C || T;
    if (Za.has(y.response.status) && ee && ve(ee.formMethod))
      await $e(z, F, {
        submission: { ...ee, formAction: D },
        preventScrollReset: N || H,
  ...
  async function qe(d, y, E, C) {
    let T,
      N = {};
    try {
      T = await uo(u, d, y, C, E, !1);
    } catch (I) {
      return (
        y
          .filter(D => D.shouldLoad)
          .forEach(D => {
            N[D.route.id] = { type: 'error', error: I };
          }),
        N
      );
    }
    ...
    for (let [I, D] of Object.entries(T))
      if (wo(D)) {
        let F = D.result;
        N[I] = { type: 'redirect', response: mo(F, d, I, y, l) };
      } else N[I] = await ho(D);
    return N;
  }
  async function Mr(d, y, E, C) {
    let T = qe(E, d, C, null),
      N = Promise.all(
        y.map(async F => {
          if (F.matches && F.match && F.request && F.controller) {
            ...
            return Promise.resolve({
              [F.key]: { type: 'error', error: Ee(404, { pathname: F.path }) },
            });
        })
      ),
      I = await T,
      D = (await N).reduce((F, z) => Object.assign(F, z), {});
  ...
  function Pe(d, y, E, C = {}) {
    let T = Ae(v.matches, y);
    (jt(d),
      he(
        { errors: { [T.route.id]: E }, fetchers: new Map(v.fetchers) },
  ...
  function Or(d) {
    ...
    for (let [E, C] of de)
      if (C < d) {
        ...
        (J(T, `Expected fetcher: ${E}`),
          T.state === 'loading' && (_e(E), de.delete(E), y.push(E)));
      }
    return (_r(y), y.length > 0);
  }
  function ua(d, y) {
    let E = v.blockers.get(d) || tt;
  ...
  function kr({ currentLocation: d, nextLocation: y, historyAction: E }) {
    if (V.size === 0) return;
    ...
    if (
      ...
      N({ currentLocation: d, nextLocation: y, historyAction: E })
    )
      return T;
  }
  function Ht(d) {
    let y = Ee(404, { pathname: d }),
      E = s || i,
      { matches: C, route: T } = gt(E);
    return { notFoundMatches: C, route: T, error: y };
  }
  function ca(d, y, E) {
    if (((g = d), (M = y), (R = E || null), !w && v.navigation === Vt)) {
      w = !0;
      let C = $r(v.location, v.matches);
      C != null && he({ restoreScrollPosition: C });
    }
    return () => {
      ((g = null), (M = null), (R = null));
    };
  }
  function Nr(d, y) {
    return (
    ...
    for (;;) {
      ...
      try {
        await e.patchRoutesOnNavigation({
          ...
          fetcherKey: C,
          patch: (U, A) => {
            E.aborted || Gr(U, A, I, D, a, !1);
          },
        });
      } catch (U) {
        return { type: 'error', error: U, partialMatches: T };
      } finally {
        N && !E.aborted && (i = [...i]);
      }
      ...
      if (
        !z ||
        (T.length === z.length &&
          T.every((U, A) => U.route.id === z[A].route.id))
      )
...
function Qt(e, t, r, n, a, o) {
  ...
  let l = cr(n || '.', ur(i), we(e.pathname, r) || e.pathname, o === 'path');
  if (
    ...
    if (s.route.index && !u)
      ...
      let c = new URLSearchParams(l.search),
        f = c.getAll('index');
      (c.delete('index'), f.filter(g => g).forEach(g => c.append('index', g)));
      let p = c.toString();
      l.search = p ? `?${p}` : '';
    }
  }
  return (
    r !== '/' && (l.pathname = Ha({ basename: r, pathname: l.pathname })),
    ke(l)
  );
}
function Vr(e, t, r) {
  if (!r || !no(r)) return { path: t };
  if (r.formMethod && !Eo(r.formMethod))
    return { path: t, error: Ee(405, { method: r.formMethod }) };
  let n = () => ({ path: t, error: Ee(400, { type: 'invalid-body' }) }),
...
function Jr(e, t, r, n, a, o, i, s, l, u, c, f, p, g, R, M, w, S, P, O) {
  var le;
  let k = O ? (ge(O[1]) ? O[1].error : O[1].data) : void 0,
        ...
        (L != null && Q > L
          ...
          : K.lazy
            ...
            : K.loader == null
              ? (ae = !1)
              : c
                ? (ae = Zt(K, o.loaderData, o.errors))
                : ao(o.loaderData, o.matches[Q], X) && (ae = !0),
        ae !== null)
      )
        return er(r, n, e, X, u, t, ae);
      let fe = j
          ? !1
          : f ||
  ...
  return (
    R.forEach((X, Q) => {
      ...
      let K = o.fetchers.get(Q),
        ae = K && K.state !== 'idle' && K.data === void 0,
        fe = Me(w, X.path, S);
      if (!fe) {
        if (P && ae) return;
        ue.push({
      ...
      else if (ae) f && ($ = Ge(r, n, x, fe, de, u, t));
      else {
...
function Pn(e, t, r, n, a) {
  let o = xn({
    ...
    i = io(n.route, ve(r.method) ? 'action' : 'loader', t, e, a);
  return {
    middleware: o,
    ...
    if (r || n)
      if (f) {
        ...
        if (p) [i] = await Promise.all([c(p), n]);
          ...
          throw Ee(405, { method: e.method, pathname: R, routeId: t.route.id });
    ...
    e.forEach(f => {
      ...
      if (
        ...
        if ((c !== void 0 && ((R = c), (c = void 0)), (i = i || {}), a))
          ...
          let M = Ae(e, p);
          i[M.route.id] == null && (i[M.route.id] = R);
        }
        (n || (o[p] = bn),
...
function en(e, t, r, n, a, o) {
  let { loaderData: i, errors: s } = po(t, r, n);
  return (
    a
      ...
      .forEach(l => {
        ...
        if ((J(p, 'Did not find corresponding fetcher result'), ge(p))) {
          let g = Ae(e.matches, c == null ? void 0 : c.route.id);
...
function vo(e) {
  return (
    e != null &&
    typeof e == 'object' &&
    Object.entries(e).every(([t, r]) => typeof t == 'string' && go(r))
  );
}
function go(e) {
  return (
...
function wo(e) {
  return fr(e.result) && Qa.has(e.result.status);
}
function ge(e) {
  return e.type === 'error';
}
...
var Lo = h.createContext(!1);
function Po() {
  return h.useContext(Lo);
}
var mr = h.createContext({ isTransitioning: !1 });
mr.displayName = 'ViewTransition';
var Tn = h.createContext(new Map());
Tn.displayName = 'Fetchers';
var Mo = h.createContext(null);
Mo.displayName = 'Await';
var Re = h.createContext(null);
...
function To(e, { relative: t } = {}) {
  J(st(), 'useHref() may be used only in the context of a <Router> component.');
  let { basename: r, navigator: n } = h.useContext(Re),
...
function Dn(e) {
  h.useContext(Re).static || h.useLayoutEffect(e);
}
function _o() {
...
function Do() {
  ...
  let e = h.useContext(We),
    { basename: t, navigator: r } = h.useContext(Re),
    { matches: n } = h.useContext(be),
    { pathname: a } = Le(),
    o = JSON.stringify(ur(n)),
    i = h.useRef(!1);
  return (
    Dn(() => {
      i.current = !0;
    ...
    h.useCallback(
      (l, u = {}) => {
        if ((oe(i.current, _n), !i.current)) return;
        if (typeof l == 'number') {
          r.go(l);
          return;
        }
        let c = cr(l, JSON.parse(o), a, u.relative === 'path');
        (e == null &&
          t !== '/' &&
...
function Ao(e) {
  ...
  return t && h.createElement(Oo.Provider, { value: e }, t);
}
function On() {
...
function ut(e, { relative: t } = {}) {
  let { matches: r } = h.useContext(be),
    { pathname: n } = Le(),
    a = JSON.stringify(ur(r));
  return h.useMemo(() => cr(e, JSON.parse(a), n, t === 'path'), [e, a, n, t]);
}
function ko(e, t, r, n, a) {
  ...
  let { navigator: o } = h.useContext(Re),
      ...
      s &&
        (l < 0 && f === 0
          ? (Nn(
            ...
            (M = null))
          : l === f &&
            ((g = !0), (M = c.route.hydrateFallbackElement || null))));
...
var Ll = ['HydrateFallback', 'hydrateFallbackElement'],
  Yo = class {
    constructor() {
      ((this.status = 'pending'),
...
function Pl({ router: e, flushSync: t, unstable_onError: r }) {
    ...
    S = h.useCallback(
      (b, { deletedFetchers: v, flushSync: L, viewTransitionOpts: H }) => {
        (b.fetchers.forEach((G, re) => {
          G.data !== void 0 && M.current.set(re, G.data);
        }),
          v.forEach(G => M.current.delete(G)),
          nr(
            L === !1 || t != null,
...
function Xo() {
  return { params: On(), loaderData: An(), actionData: kn(), matches: vr() };
}
function Tl(e) {
  return function () {
    const r = Xo();
...
function Ko() {
  return { params: On(), loaderData: An(), actionData: kn(), error: gr() };
}
function _l(e) {
  return function () {
    const r = Ko();
...
function ai(e, t) {
  ...
  if (Qo(e)) {
    ...
    ((n = s ? we(s, t) : null),
      ...
      (a = Gt(e.getAttribute('enctype')) || Pt),
      (o = new FormData(e)));
      ...
      if (typeof c[0] == 'string') {
        ...
        switch (f) {
          ...
          case pi:
            ...
            t[l] = w;
            for (const k of Object.keys(p).reverse()) {
              const b = [];
              (i.push([
                p[k],
                v => {
          ...
          case In:
            if (t[p]) u((t[l] = t[p]));
              ...
              const k = new Fn();
              ((n[p] = k), u((t[l] = k.promise)));
            }
            continue;
          case $n:
            const [, S, P] = c;
            let O = P && Xt && Xt[P] ? new Xt[P](S) : new Error(S);
            ((t[l] = O), u(O));
            continue;
          case Ei:
            u((t[l] = t[p]));
...
async function Ti(e, t, r) {
  ...
  return fr(o.result) || Be(o.result) || rr(o.result)
    ? { [n.route.id]: o }
    : { [n.route.id]: { type: o.type, result: Ja(o.result, a) } };
}
...
async function Di(e, t, r, n, a, o, i = () => !0) {
  let s = new Set(),
    ...
    f = {},
    p = Promise.all(
      e.matches.map(async (R, M) =>
        R.resolve(async w => {
          u[M].resolve();
          let S = R.route.id,
            { hasLoader: P, hasClientLoader: O, hasShouldRevalidate: k } = r(R),
            b =
          ...
          if (!R.unstable_shouldCallHandler(b)) {
            l || (l = R.unstable_shouldRevalidateArgs != null && P && k === !0);
            return;
          }
          if (i(R) && O) {
            P && (l = !0);
  ...
  try {
    ...
    o !== void 0 &&
      Array.from(r.values()).forEach(s => {
        n[s].result instanceof jn && (n[s].result = o);
      });
  } catch {}
}
...
function lt(e, t) {
  ...
  let r = e.routes[t];
  if (r == null) throw new jn(`No result found for routeId "${t}"`);
...
async function Fi(e) {
  if (!e.css) return;
  let t = zn(e);
  await Promise.all(t.map(Wn));
}
async function Bn(e, t) {
  if ((!e.css && !t.links) || !Bi()) return;
  let r = [];
  if (
    (e.css && r.push(...zn(e)), t.links && r.push(...t.links()), r.length === 0)
  )
    return;
  let n = [];
  for (let a of r)
...
function Rr(e, t, r, n, a, o = '', i = Vn(e), s) {
  return (i[o] || []).map(l => {
    var P, O, k;
    let u = t[l.id];
    function c(b) {
    ...
    function p(b) {
      if (!l.hasAction) throw Kt('action', l.id);
      return c(b);
    }
    function g(b) {
      import(b);
    ...
    if (u) {
      ...
      let b = r && r.loaderData && l.id in r.loaderData,
        ...
        j =
          s == null &&
          (((k = u.clientLoader) == null ? void 0 : k.hydrate) === !0 ||
            !l.hasLoader);
        ...
        (w.action = ({ request: G, params: re, context: ue }, le) =>
          M(async () => {
            if (
              ...
              if (a) throw Kt('clientAction', l.id);
              return p(le);
            }
      ...
      (l.hasClientLoader || (w.loader = (L, H) => M(() => f(H))),
        l.hasClientAction ||
          (w.action = (L, H) =>
            M(() => {
              if (a) throw Kt('clientAction', l.id);
  ...
  h.useEffect(() => {
    ...
    async function s() {
      document
        ...
        .forEach(i);
      let p = Array.from(Mt.keys()).filter(g =>
        Dt.has(g) ? (Mt.delete(g), !1) : !0
      );
      if (p.length !== 0)
        try {
          await Gn(
...
async function Gn(e, t, r, n, a, o, i, s, l, u) {
  ...
  try {
    ...
    (sessionStorage.removeItem(qt), (p = await w.json()));
  } catch (w) {
  ...
  (Object.values(R).forEach(w => {
    w && (!w.parentId || !R[w.parentId]) && M.add(w.parentId);
  }),
    M.forEach(w => l(w || null, Rr(R, n, null, a, o, w))));
}
function Zi(e, t) {
  if (t.size >= Xi) {
...
function Nl({ nonce: e }) {
  let { isSpaMode: t, manifest: r, routeModules: n, criticalCss: a } = Ke(),
    { errors: o, matches: i } = Nt(),
    s = xr(i, o, t),
  ...
  return h.createElement(
    ...
    l.map(({ key: u, link: c }) =>
      wr(c)
        ? h.createElement(Xn, { key: u, nonce: e, ...c })
...
function rl(e) {
  let { manifest: t, routeModules: r } = Ke(),
    [n, a] = h.useState([]);
  return (
    h.useEffect(() => {
      let o = !1;
...
function nl({ page: e, matches: t, ...r }) {
  let n = Le(),
    { manifest: a, routeModules: o } = Ke(),
    { basename: i } = Sr(),
    { loaderData: s, matches: l } = Nt(),
    ...
    f = h.useMemo(() => {
      ...
      if (
        (t.forEach(S => {
          ...
          !P ||
            !P.hasLoader ||
            ((!u.some(k => k.route.id === S.route.id) &&
              S.route.id in s &&
              (O = o[S.route.id]) != null &&
              O.shouldRevalidate) ||
            P.hasClientLoader
  ...
  return h.createElement(
    ...
    g.map(({ key: R, link: M }) =>
      h.createElement('link', { key: R, nonce: r.nonce, ...M })
    )
  );
}
function $l() {
  let { isSpaMode: e, routeModules: t } = Ke(),
...
function il(e) {
  ...
  let R = h.useMemo(() => {
      ...
      let P = u
          ...
          : ' ',
        O = l
          ? `${(k = t.hmr) != null && k.runtime ? `import ${JSON.stringify(t.hmr.runtime)};` : ''}${p ? '' : `import ${JSON.stringify(t.url)}`};
${g.map((b, v) => {
  let L = `route${v}`,
  ...
  let Q = X.map(ae => `import * as ${ae.varName} from "${ae.module}";`).join(`
`),
    K = `const ${L} = {${X.map(ae => `...${ae.varName}`).join(',')}};`;
  return [Q, K].join(`
`);
}).join(`
`)}
...
var Il = class extends h.Component {
  ...
  render() {
    return this.state.error
      ? h.createElement(Kn, { error: this.state.error, isOutsideRemixApp: !0 })
      : this.props.children;
  }
};
function Kn({ error: e, isOutsideRemixApp: t }) {
  console.error(e);
...
try {
  qn && (window.__reactRouterVersion = '7.8.2');
} catch {}
var Qn = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  Zn = h.forwardRef(function (
    ...
    let { basename: R } = h.useContext(Re),
      M = typeof u == 'string' && Qn.test(u),
      w,
      S = !1;
    if (typeof u == 'string' && M && ((w = u), qn))
      try {
    ...
    return O && !M
      ? h.createElement(h.Fragment, null, H, h.createElement(Xn, { page: P }))
      : H;
  });
Zn.displayName = 'Link';
var ul = h.forwardRef(function (
  ...
  let f = ut(i, { relative: u.relative }),
    p = Le(),
    g = h.useContext(Xe),
    { navigator: R, basename: M } = h.useContext(Re),
    w = g != null && El(f) && s === !0,
  ...
  (r ||
    ...
    (S = S.toLowerCase())),
    O && M && (O = we(O, M) || O));
  const k = S !== '/' && S.endsWith('/') ? S.length - 1 : S.length;
  let b = P === S || (!a && P.startsWith(S) && P.charAt(k) === '/'),
    v =
      O != null &&
...
var cl = h.forwardRef(
  (
    ...
    let R = yl(),
      ...
      S = typeof s == 'string' && Qn.test(s),
      P = O => {
        if ((l && l(O), O.defaultPrevented)) return;
        O.preventDefault();
        let k = O.nativeEvent.submitter,
          b = (k == null ? void 0 : k.getAttribute('formmethod')) || i;
        R(k || O.currentTarget, {
          fetcherKey: t,
          method: b,
          navigate: r,
...
function dl({ getKey: e, storageKey: t, ...r }) {
  let n = h.useContext($t),
    { basename: a } = h.useContext(Re),
    o = Le(),
    i = vr();
  ...
  return h.createElement('script', {
    ...
    suppressHydrationWarning: !0,
    dangerouslySetInnerHTML: {
      __html: `(${l})(${JSON.stringify(t || lr)}, ${JSON.stringify(s)})`,
    },
  });
}
...
function El(e, { relative: t } = {}) {
  ...
  return Tt(a.pathname, i) != null || Tt(a.pathname, o) != null;
}
export {
  ze as E,
  $t as F,
